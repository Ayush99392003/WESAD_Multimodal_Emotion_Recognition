...
def main():
    ...
    print("=== WESAD Modality Combination Evaluation (AdaBoost with Max Depth 100) ===")
        ...
        for fold, (train_idx, test_idx) in enumerate(gkf.split(X, y, groups)):
            ...
            model = AdaBoostClassifier(
                estimator=DecisionTreeClassifier(
                    max_depth=100,  # Main parameter change
            ...
            acc, bal_acc, overall_f1, report = evaluate_model(model, X_test, y_test, class_names)
    ...
    final_df.to_csv('wesad_ab_maxdepth100_results.csv', index=False)
    ...
    with open('ab_maxdepth100_comparison_summary.txt', 'w') as f:
        f.write("=== WESAD Modality Combination Results (AdaBoost with Max Depth 100) ===\n\n")
    ...
    print("\nAdaBoost analysis complete. Results saved to:")
    print("- wesad_ab_maxdepth100_results.csv")
    print("- ab_maxdepth100_comparison_summary.txt")
