...
def main():
    ...
    print("=== WESAD Modality Combination Evaluation (Decision Tree) ===")
    ...
    final_df.to_csv('wesad_dt_modality_comparison_results.csv', index=False)
    ...
    with open('dt_modality_comparison_summary.txt', 'w') as f:
        f.write("=== WESAD Modality Combination Results (Decision Tree) ===\n\n")
    ...
    print("\nDecision Tree analysis complete. Results saved to:")
    print("- wesad_dt_modality_comparison_results.csv")
    print("- dt_modality_comparison_summary.txt")
